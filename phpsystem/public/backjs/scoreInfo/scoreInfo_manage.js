						...
						if (scoreInfo) { 
							...
							$("#scoreInfo_studentNumber_studentNumber_edit").combobox({
						        ...
						        onLoadSuccess: function () { //数据加载完毕事件
									$("#scoreInfo_studentNumber_studentNumber_edit").combobox("select", scoreInfo.studentNumber);
							...
							$("#scoreInfo_courseNo_courseNo_edit").combobox({
						        ...
						        editable: false, //不允许手动输入 
						        onLoadSuccess: function () { //数据加载完毕事件
									$("#scoreInfo_courseNo_courseNo_edit").combobox("select", scoreInfo.courseNo);
							...
							$("#scoreInfo_termId_termId_edit").combobox({
						        ...
						        editable: false, //不允许手动输入 
						        onLoadSuccess: function () { //数据加载完毕事件
									$("#scoreInfo_termId_termId_edit").combobox("select", scoreInfo.termId);
