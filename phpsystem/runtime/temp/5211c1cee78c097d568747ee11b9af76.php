<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"C:\xampp\htdocs\phpsystem\public/../application/back\view\index\index.html";i:1539233951;}*/ ?>
﻿<!DOCTYPE html>
<html>
<head>
    <title>信息管理系统</title>
...
<div data-options="region:'north',title:'header',split:true,noheader:true" style="height:60px;background-color:#c0a16b;border:0px;">
    <div class="logo">PHP网站后台管理【ThinkPHP5框架】</div>
