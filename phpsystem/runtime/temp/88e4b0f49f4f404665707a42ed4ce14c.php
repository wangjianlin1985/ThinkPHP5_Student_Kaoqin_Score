...
<script>
		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" ><a href="<?php echo url('ClassInfo/frontAdd'); ?>" style="display:none;">添加班级信息</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>班级编号</td><td>班级名称</td><td>班主任姓名</td><td>成立日期</td><td>操作</td></tr>
				    					<?php
				    						/*计算起始序号*/
				    					...
				    					if(is_array($classInfoRs) || $classInfoRs instanceof \think\Collection): $i = 0; $__LIST__ = $classInfoRs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$classInfo): $mod = ($i % 2 );++$i;?>
 										<tr>
 											...
 											<td><?php echo $classInfo['banzhuren']; ?></td>
 											<td><?php echo $classInfo['beginDate']; ?></td>
 											<td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="classInfoQueryForm" id="classInfoQueryForm" action="<?php echo url('ClassInfo/frontlist'); ?>" class="mar_t15" method="post">
			...
			<div class="form-group">
				<label for="banzhuren">班主任姓名:</label>
				<input type="text" id="banzhuren" name="banzhuren" value="<?php echo $banzhuren; ?>" class="form-control" placeholder="请输入班主任姓名">
			</div>
			<div class="form-group">
				<label for="beginDate">成立日期:</label>
				<input type="text" id="beginDate" name="beginDate" class="form-control"  placeholder="请选择成立日期" value="<?php echo $beginDate; ?>" onclick="SelectDate(this,'yyyy-MM-dd')" />
			</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 ...
		  	 <div class="col-md-9">
			    <input type="text" id="classInfo_banzhuren_edit" name="classInfo_banzhuren" class="form-control" placeholder="请输入班主任姓名">
			 </div>
		  </div>
		  <div class="form-group">
		  	 ...
		  	 <div class="col-md-9">
                <div class="input-group date classInfo_beginDate_edit col-md-12" data-link-field="classInfo_beginDate_edit"  data-link-format="yyyy-mm-dd">
                    <input class="form-control" id="classInfo_beginDate_edit" name="classInfo_beginDate" size="16" type="text" value="" placeholder="请选择成立日期" readonly>
