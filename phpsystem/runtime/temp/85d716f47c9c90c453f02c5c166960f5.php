<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"C:\xampp\htdocs\phpsystem\public/../application/back\view\termInfo\termInfo_query.html";i:1539321736;}*/ ?>
...
<div id="termInfoEditDiv">
	<form id="termInfoEditForm" enctype="multipart/form-data"  method="post">
		<div>
			<span class="label">学期编号:</span>
			<span class="inputControl">
				<input class="textbox" type="text" id="termInfo_termId_edit" name="termInfo_termId" style="width:200px" />
			</span>
		</div>
		<div>
			<span class="label">学期名称:</span>
			<span class="inputControl">
				<input class="textbox" type="text" id="termInfo_termName_edit" name="termInfo_termName" style="width:200px" />
...
<script type="text/javascript" src="__PUBLIC__/backjs/termInfo/termInfo_manage.js"></script>
